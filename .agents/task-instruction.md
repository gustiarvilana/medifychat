...
**Proyek:** Medify Chat (Chat Service)
...
3. Ikuti panduan layout di folder `/design` secara ketat untuk semua hal yang berhubungan dengan UI/UX, warna, layout, dan komponen.
4. Kerjakan task secara bertahap dan rapi.
